...
namespace Logic_tier
{
    ...
    public class Logic
    {
        ...
        {
            bpList_.Add(new DTO_BSugar(6.5, new DateTime(2015, 1, 30, 8, 0, 0)));
            bpList_.Add(new DTO_BSugar(5.6, new DateTime(2015, 1, 30, 12, 30, 0)));
            bpList_.Add(new DTO_BSugar(11.5, new DateTime(2015, 1, 30, 18, 45, 0)));
            bpList_.Add(new DTO_BSugar(3.7, new DateTime(2015, 1, 30, 22, 15, 0)));
            bpList_.Add(new DTO_BSugar(6.4, new DateTime(2015, 1, 31, 8, 0, 0)));
            bpList_.Add(new DTO_BSugar(6.0, new DateTime(2015, 1, 31, 15, 22, 0)));
            bpList_.Add(new DTO_BSugar(7.9, new DateTime(2015, 2, 1, 8, 0, 0)));
            bpList_.Add(new DTO_BSugar(4.8, new DateTime(2015, 2, 1, 10, 30, 0)));
            bpList_.Add(new DTO_BSugar(15.3, new DateTime(2015, 2, 1, 21, 0, 0)));
            bpList_.Add(new DTO_BSugar(6.2, new DateTime(2015, 2, 2, 8, 15, 0)));
        }
